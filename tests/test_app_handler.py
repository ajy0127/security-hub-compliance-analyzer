...
class TestAppHandler(unittest.TestCase):
    ...
    def test_lambda_handler_email_error_paths(self, mock_boto3_client, mock_soc2_mapper_class):
    ...
    def test_lambda_handler_no_findings(self, mock_get_findings, mock_soc2_mapper_class, mock_boto3_client):
    ...
    def test_cli_handler_report_command(
        self, mock_print, mock_input, mock_soc2_mapper_class, mock_send_email,
        mock_generate_csv, mock_analyze_findings, mock_get_findings,
        ...
        mock_parser.add_subparsers.return_value.add_parser.side_effect = [mock_report_parser, mock_test_parser]
    ...
    def test_cli_handler_test_email_command(
        self, mock_print, mock_soc2_mapper_class, mock_send_test_email,
        mock_argument_parser
    ):
    ...
    @patch('app.argparse.ArgumentParser')
    @patch('app.SOC2Mapper')
    def test_cli_handler_no_command(
        self, mock_soc2_mapper_class, mock_argument_parser
    ):
    ...
    def test_cli_handler_report_no_findings(
        self, mock_print, mock_soc2_mapper_class, mock_get_findings, mock_argument_parser
    ):
